...
(function () {
    ...
    if (!mstrmojo.plugins.MstrVisD3MultiChart) {
        mstrmojo.plugins.MstrVisD3MultiChart = {};
    }
    // Visualization requires library to render, and in this
    mstrmojo.requiresCls("mstrmojo.CustomVisBase");
    // Declaration of the visualization object
    mstrmojo.plugins.MstrVisD3MultiChart.MstrVisD3MultiChart = mstrmojo.declare(
        ...
        null,
        {
            ...
            scriptClass: 'mstrmojo.plugins.MstrVisD3MultiChart.MstrVisD3MultiChart',
            model: null,
            cssClass: "MstrVisD3MultiChart",
            errorDetails: "This visualization requires at least 3 metrics.",
            useRichTooltip: true,
            reuseDOMNode: true,
            externalLibraries: [
                {
                    ...
                    url: "https://rawgit.com/gka/d3-jetpack/master/d3-jetpack.js"                       
                }
            ],
            /**
